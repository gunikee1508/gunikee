...
<div id='busca'>
          ...
          <input oninput="mascara(this)" type="text"  id="txtbusca" name="cpf" placeholder="Digite seu cpf" size="14"> 
<br><br>
<br><br>
          <input type="password" id="txtbusca"  name="nsenha" placeholder="Digite sua senha nova" size="50"> 
